...
_CN.latentcostformer.encoder_latent_dim = 128 # in twins, this is 256
...
_CN.latentcostformer.cost_latent_dim = 64
_CN.latentcostformer.predictor_dim = 64
_CN.latentcostformer.motion_feature_dim = 50 # use concat, so double query_latent_dim
...
_CN.latentcostformer.patch_size = 4
_CN.latentcostformer.patch_embed = 'single'
_CN.latentcostformer.gma = False
_CN.latentcostformer.rm_res = True
_CN.latentcostformer.vert_c_dim = 32
...
_CN.latentcostformer.vertical_conv = True
# decoder
_CN.latentcostformer.decoder_depth = 3
